...
function salat_times_options_page() {
  ...
  if (!is_array($st_options)) {
   ...
   ?>
    ...
    <div class="postbox" style="display: block;float:left;margin:5px;clear:left; width: 100%;">
	<h3 class="hndle" style="padding:5px;"><span>Location Settings</span></h3>
<div class="inside">
    ...
    <div class="postbox" style="display: block;float:left;margin:5px;clear:left; width: 100%;">
	<h3 class="hndle" style="padding:5px;"><span>Calculation Settings</span></h3>
<div class="inside">
    <table class="form-table">
        <tr valign="top">
        <td>Juristic Method (<a href="#help">?</a>):</td>
        <td>
        <select name="st_options[asr_method]">
        ...
        <tr valign="top">
        <td>Calculation Method (<a href="#help">?</a>):</td>
        <td>
        <select name="st_options[calc_method]">
    ...
    <div class="postbox" style="display: block;float:left;margin:5px;clear:left; width: 100%;">
	<h3 class="hndle" style="padding:5px;"><span>Widget Settings: Daily Salat Times</span></h3>
<div class="inside">
    <table class="form-table">
        <tr valign="top">
        <td>Language:</td>
        <td>
        <select name="st_options[lang]">
        ...
        <tr valign="top">
        <td>Widget Title:</td>
        <td><input type="text" maxlength="99" name="st_options[wgt_title1]" value="<?php echo $st_options['wgt_title1']; ?>" /> </td>
        </tr>
        <tr valign="top">
        <td>Location Name:</td>
        <td><input type="text" maxlength="99" name="st_options[location]" value="<?php echo $st_options['location']; ?>" /> (Will be displayed on widget.)</td>
        </tr>
        <tr valign="top">
        <td>Time Format:</td>
        <td>
        <select name="st_options[time_format]">
        ...
        </select> Use "<span style="color: green;">12 Hour (No suffix)</span>" for "<span style="color: green;">Bengali</span>" language.
        </td>
        </tr>
        <tr valign="top">
        <td>Show Date:</td>
        <td><input type="checkbox" id="show_date" name="st_options[show_date]" value="1" <?php if($st_options['show_date']==1) echo('checked="checked"'); ?>/><label for="show_date">Gregorian Date</label></td>
        </tr>
        <tr valign="top">
        <td>Table width:</td>
        <td><input type="text" maxlength="5" name="st_options[width]" value="<?php echo $st_options['width']; ?>" /> (Example: 90%, 200px etc.)</td>
        </tr>
        <tr valign="top">
        <td colspan="2" style="border-top: 1px solid silver; background-color: #F4F4F4">
        ...
        <p>PHP code: <code><span style="color: #000000"><span style="color: #0000BB">   &#60;&#63;php echo do_shortcode&#40;&#39;[daily_salat_times]&#39;&#41;; </span><span style="color: #0000BB">&#63;&#62;</span></span></code></p>
        </td>
        </tr>
        </table>
        </div></div>
    ...
    <input type="hidden" name="st_options[lat_long_tz]" value="23.7 90.4 6">
    <input type="hidden" name="st_options[lat]" value="23.7">
    <input type="hidden" name="st_options[long]" value="90.4">
    <input type="hidden" name="st_options[custom_loc]" value="0">
    <input type="hidden" name="st_options[calc_method]" value="1">
    <input type="hidden" name="st_options[asr_method]" value="0">
    <input type="hidden" name="st_options[time_format]" value="1">
    <input type="hidden" name="st_options[time_zone]" value="6">
    <input type="hidden" name="st_options[wgt_title1]" value="Salat Times">
    <input type="hidden" name="st_options[location]" value="Dhaka, Bangladesh">
    <input type="hidden" name="st_options[show_date]" value="1">
    <input type="hidden" name="st_options[width]" value="100%">
    <input type="hidden" name="st_options[lang]" value="en">
    <input type="submit" value="Restore Default Settings" class="button button-secondary">
    </form>
    <br />
    
    <div class="postbox" style="display: block;float:left;margin:5px;clear:left; width: 100%;">
    <h3 class="hndle" style="padding:5px;"><span><a name="help"></a>Help</span></h3>
	<div class="inside">
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="fb-like-box" data-href="https://www.facebook.com/islamicmediabd" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
    </td>
    </tr>
    </table>
    </div></div>
